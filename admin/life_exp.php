...
if(isset($_POST['submit'])){
	...
	$variant=encode($_POST['variant']);
	$price=encode($_POST['price']);
                    ...
                    <tr>
                        ...
                        <td>
                        	<select name="category" required="required" class="form-control">
                            	...
                            	<option value="4">4 Life Experience</option>
                                <option value="8">8 Life Experience</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    	<td>Variant(Option)</td>
                        <td><input type="text" name="variant" required="required" class="form-control" spellcheck="false" /></td>
                    </tr>
                    <tr>
                    	<td>Price($)</td>
                        <td><input type="text" name="price" required="required" class="form-control" spellcheck="false" /></td>
                    </tr>
                    <tr align="right">
                    	<td colspan="2"><input type="submit" name="submit" value="Add Life Experience" class="btn btn-primary" /></td>
                    </tr>
                </table>
                </form>
